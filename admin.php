...
<body class="min-h-screen bg-body text-white flex flex-col items-center p-8">
    ...
    <nav class="w-full max-w-6xl mb-8">
        <ul class="flex gap-4 justify-center">
            <li>
                <button class="px-4 py-2 bg-blue-500 text-white rounded-full mulish hover:bg-blue-600 transition" onclick="toggleModal()">Tambah Barang Baru</button>
            </li>
            <li>
                <button class="px-4 py-2 bg-green-500 text-white rounded-full mulish hover:bg-green-600 transition" onclick="toggleStockModal()">Add Stok</button>
            </li>
            <li>
                <button class="px-4 py-2 bg-blue-500 text-white rounded-full mulish hover:bg-blue-600 transition" onclick="togglePengambilanModal()">Ambil Barang</button>
            </li>
            <li><a href="history.php" class="px-4 py-2 bg-pink-500 text-white rounded-full mulish hover:bg-pink-600 transition">History</a></li>
        </ul>
    </nav>
    ...
    <div class="w-full max-w-6xl">
        ...
        <table class="table-auto w-full bg-glass rounded-lg overflow-hidden">
            ...
            <tbody>
                <?php
                $query = "SELECT id, nama_barang, stok, satuan, created_at FROM barang ORDER BY stok ASC";
        ...
        <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form method="POST" action="process_input_barang.php" class="text-black">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="satuan" name="satuan" class="w-full border-gray-300 rounded-md focus:ring focus:ring-blue-200 p-2" required>
                </div>
        ...
        <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form method="POST" action="process_edit_barang.php" class="text-black">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="edit_nama_barang" name="nama_barang" class="w-full border-gray-300 rounded-md focus:ring focus:ring-blue-200 p-2" required>
                </div>
                <div class="mb-4">
                    <label for="edit_stok" class="block text-gray-700">Stok:</label>
                    <input type="number" id="edit_stok" name="stok" class="w-full border-gray-300 rounded-md focus:ring focus:ring-blue-200 p-2" required>
                </div>
                <div class="mb-4">
                    <label for="edit_satuan" class="block text-gray-700">Satuan:</label>
                    <input type="text" id="edit_satuan" name="satuan" class="w-full border-gray-300 rounded-md focus:ring focus:ring-blue-200 p-2" required>
                </div>
                <div class="flex justify-end">
                    <button type="button" class="px-4 py-2 bg-gray-500 text-white rounded-full mr-2" onclick="toggleEditModal()">Batal</button>
                    <button type="submit" class="px-4 py-2 bg-green-500 text-white rounded-full">Simpan</button>
                </div>
            </form>
        </div>
        ...
        <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form method="POST" action="process_tambah_stok.php" class="text-black">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" id="stok_tambah" name="stok_tambah" class="w-full border-gray-300 rounded-md focus:ring focus:ring-blue-200 p-2" required>
                </div>
                <div class="flex justify-end">
                    <button type="button" class="px-4 py-2 bg-gray-500 text-white rounded-full mr-2" onclick="toggleStockModal()">Batal</button>
                    <button type="submit" class="px-4 py-2 bg-green-500 text-white rounded-full">Simpan</button>
                </div>
            </form>
        </div>
        ...
        <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form method="POST" action="process_pengambilan.php" class="text-black">
                <div class="mb-4">
                    ...
                    <input type="text" id="nama_barang_pengambilan" name="nama_barang" class="w-full border-gray-300 rounded-md focus:ring focus:ring-blue-200 p-2" required>
                </div>
                <div class="mb-4">
                    <label for="jumlah_pengambilan" class="block text-gray-700">Jumlah:</label>
                    <input type="number" id="jumlah_pengambilan" name="jumlah" class="w-full border-gray-300 rounded-md focus:ring focus:ring-blue-200 p-2" required>
                </div>
                <div class="flex justify-end">
                    <button type="button" class="px-4 py-2 bg-gray-500 text-white rounded-full mr-2" onclick="togglePengambilanModal()">Batal</button>
