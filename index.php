...
<body class="min-h-screen bg-body text-white flex flex-col items-center p-8">
    <header class="flex justify-between items-center w-full max-w-6xl">
        ...
        <a href="login.php" class="px-6 py-2 bg-white text-black rounded-full mulish hover:bg-gray-200 transition">Login</a>
    </header>
    <div class="w-full max-w-6xl flex justify-between items-center mb-6">
        <h1 class="text-3xl mulish font-bold">Daftar Barang</h1>
        <div>
            <a href="#" class="px-4 py-2 bg-green-500 text-white rounded-full mulish hover:bg-green-600 transition">History</a>
            <a href="#" class="px-4 py-2 bg-red-500 text-white rounded-full mulish hover:bg-red-600 transition">Stok</a>
        </div>
    </div>
